...
export class CountryComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private web: WebserviceService) {
    this.recoveredY = [];
    this.casesY = [];
    this.deathsY = [];
    this.dateX = [];
  ...
  ngOnInit() {
    ...
    this.sub1 = this.web
      .getHistoricalDataByCountry(this.activeCountry)
      .pipe(catchError((err) => of("none")))
      .subscribe((res) => {
        ...
        if (res != "none") {
          ...
          this.chartOptions = {
            ...
            title: {
              text:
                "Cases , deaths and recoveries of last 30 days in " +
                this.activeCountry,
            },
            subtitle: {
